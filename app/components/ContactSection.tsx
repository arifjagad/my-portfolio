      ...
      <div className="section-container relative z-10">
        <div className="max-w-3xl">
          ...
          >
            ...
            <h2 className="mb-6 text-4xl sm:text-6xl lg:text-7xl font-extrabold text-slate-100 tracking-tight leading-[1.1]">
              Punya ide menarik?
              <br />
          ...
          <div className="mb-12">
            <p className="text-slate-400 text-lg max-w-xl leading-relaxed">
              Saya selalu terbuka untuk tawaran <span className="text-slate-200 font-semibold italic">project freelance</span>, kolaborasi kreatif, maupun sekadar diskusi santai tentang dunia teknologi. Jangan sungkan untuk menyapa!
            </p>
          </div>
          ...
          {/* ── Social Links ─────────────────────────────────── */}
          <div className="flex items-center gap-6 border-t border-navy-800/50 pt-8 max-w-lg">
