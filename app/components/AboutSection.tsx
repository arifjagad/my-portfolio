        ...
        <div className="flex flex-col lg:flex-row gap-14 xl:gap-24 items-center">
          ...
          {profile.photo_url && (
            ...
            >
              ...
              <div className="relative mx-auto aspect-square w-[280px] sm:w-[320px] md:w-72 rounded-2xl overflow-hidden border border-navy-700 shadow-2xl">
                <Image
                  ...
                  sizes="(max-width: 640px) 280px, (max-width: 768px) 320px, 288px"
                />
