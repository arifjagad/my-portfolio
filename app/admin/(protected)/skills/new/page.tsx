...
async function createSkill(formData: FormData): Promise<{ error?: string; success?: boolean }> {
  "use server";
...
export default function NewTechStackPage() {
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-200">Tambah Tech Stack</h1>
        <p className="mt-1 text-sm text-slate-500">Tambah data logo framework/bahasa pemograman.</p>
      </div>
      <TechStackForm onSave={createSkill} />
    </div>
  );
}
